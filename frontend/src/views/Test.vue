    ...
    <div class="bg-white shadow rounded-lg overflow-hidden my-6">
      <table class="text-left w-full border-collapse">
        <thead class="border-b">
          <tr>
            <th class="py-3 px-5 bg-blue-800 font-medium uppercase text-sm text-gray-100">Date</th>
            <th class="py-3 px-5 bg-blue-800 font-medium uppercase text-sm text-gray-100">High</th>
            <th class="py-3 px-5 bg-blue-800 font-medium uppercase text-sm text-gray-100">Low</th>
            <th class="py-3 px-5 bg-blue-800 font-medium uppercase text-sm text-gray-100">
              Volume
            </th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="(price, index) in prices" :key="index" class="hover:bg-gray-200">
