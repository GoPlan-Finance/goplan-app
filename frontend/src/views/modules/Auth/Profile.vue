        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
          ...
          >
            ...
            <p class="text-gray-700 text-sm">
              We use Tingo as a data source for the stock prices.
            </p>
            <p class="text-gray-700 text-sm">
              When the project will officially release, we will handle it ourself, but for now you need to follow theses steps to obtain your FREE api Key
            </p>
            ...
            >
              <li>
                Go to <a
                  href="https://tingo.com"
                  target="_blank"
                >tingo.com</a> and sign up for an account
              </li>
