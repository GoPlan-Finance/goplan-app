...
const getOrNull = async (type: string, docId: string, useMasterKey: boolean = false) => {
...
const get = async (type: string, docId: string, useMasterKey: boolean = false) => {
...
const findBy = async (type: string, params: { [key: string]: string | boolean | number | Parse.Object | Parse.Pointer }, useMasterKey: boolean = false) => {
    const query = new Parse.Query(type)
...
const findOneBy = async (type: string, params: { [key: string]: string | boolean | number | Parse.Object | Parse.Pointer }, useMasterKey: boolean = false) => {
    const query = new Parse.Query(type)
...
const createWithData = async (type: string, params: { [key: string]: string | boolean | number | Parse.Object | Parse.Pointer }, useMasterKey: boolean = false) => {
